...
export const horarioConfigUTC: Record<HorarioEnum, { start: string, end: string, order: number }> = {
...
export function getCurrentHorarioEnum() {
    ...
    return currentSelectedTime !== undefined ? currentSelectedTime : 'Horario no encontrado';
}
